    ...
    <div className='postInteractions'>
        <div className="interactionIcons">
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
           ...
           stroke={data.isLiked ? "#e50829" : "#000000"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill={data.isLiked ? "#e50829" : "none"}
          />
          </svg>
          {data.likeCount}
        ...
        <button className='saveBtn' disabled={mutation.isPending} onClick={() => mutation.mutate({id:postId,type:"save"})}>{data.isSaved ? "Saved" : "Save"}</button>
    </div>
  )
}
